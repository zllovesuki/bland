/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: 8e3ab44f70f652d65dceffa0727a3131)
// Runtime types generated with workerd@1.20260415.1 2026-03-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "DocSync" | "WorkspaceIndexer";
	}
	interface Env {
		R2: R2Bucket;
		DB: D1Database;
		...
		SENTRY_DSN: string;
		BLAND_AI_MODE: string;
		BLAND_AI_OPENAI_ENDPOINT: string;
		BLAND_AI_OPENAI_API_KEY: string;
		BLAND_AI_OPENAI_CHAT_MODEL: string;
		BLAND_AI_OPENAI_SUMMARIZE_MODEL: string;
		BLAND_AI_WORKERS_CHAT_MODEL: string;
		BLAND_AI_WORKERS_SUMMARIZE_MODEL: string;
		DocSync: DurableObjectNamespace<import("./src/worker/index").DocSync>;
		WorkspaceIndexer: DurableObjectNamespace<import("./src/worker/index").WorkspaceIndexer>;
	}
}
