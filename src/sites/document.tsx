...
import { SiteOutlineControllerIslandHost } from "@/sites/island-hosts/site-outline-controller";
      ...
      <body className="site-shell flex min-h-screen flex-col bg-canvas font-sans font-[450] text-zinc-100 antialiased">
        ...
        <main id="main-content" className={`site-main flex-1 ${PAGE_SHELL_CLASS}`}>
          <DocumentFrame
            ...
            rail={hasOutline ? <SiteOutlineControllerIslandHost items={outline} /> : undefined}
            railBalance="content"
          />
        </main>
        <SiteFooter />
