...
import { CalloutPresentation } from "@/shared/editor/presentation/callout";
import { highlightCodeToSegments } from "@/shared/editor/highlight/code-highlight-runtime";
import { CodeBlockPresentation, getCodeLanguageLabel } from "@/shared/editor/presentation/code-block";
import { PageMentionPresentation } from "@/shared/editor/presentation/page-mention";
import { readOutlineLevel, type OutlineLevel } from "@/shared/editor/model/outline";
import type { SitesImageProps } from "@/shared/sites/island-schemas";
import { readOptionalSitesReactRenderContext } from "@/sites/react-render-context";
import { CopyCodeButtonIslandHost } from "@/sites/island-hosts/copy-code-button";
import { SitesImageIslandHost } from "@/sites/island-hosts/sites-image";
...
export function createBlandSitesStaticNodeMappings() {
  ...
  return {
    ...
    image: ({ node }: StaticNodeMappingProps) => {
      ...
      return <SitesImageIslandHost {...imageProps} />;
    },
