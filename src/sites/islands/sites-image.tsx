...
import { ImageElement, ImageFigureFrame, resolveImageFrameStyle } from "@/shared/editor/components/image";
...
export function SitesImage({ bid, src, alt, title, align, width, naturalWidth, naturalHeight }: SitesImageProps) {
  ...
  return (
    ...
    >
      ...
      {isLoading ? <Skeleton className="tiptap-image-load-skeleton" aria-hidden="true" /> : null}
      {errored ? (
